...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    const range = 'Updates!A:D'; // Adjust the range as needed

    const url = `https://sheets.googleapis.com/v4/spreadsheets/${sheetId}/values/${range}?valueInputOption=USER_ENTERED&key=AIzaSyAAqb3DVZpY8K0kRu65iqPjPUW61n71Jto`;
    ...
    try {
      ...
      if (response.status !== 200) {
        throw new Error(data.error.message || 'Failed to send data');
      }
