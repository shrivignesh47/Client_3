    ...
    <Navbar />
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/70 to-black/50 flex flex-col items-center justify-center">
          ...
          <ShinyText text="A journey of flavors since 1992" disabled={false} speed={3} className="custom-class fabril-fatface text-2xl" />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#121414] rounded-xl shadow-lg p-6 flex items-center space-x-4">
            ...
            <div>
              ...
              <ShinyText text="Happy Customers" disabled={false} speed={3} className="custom-class fabril-fatface text-2xl" />
            </div>
          </div>
        </div>
      </div>
